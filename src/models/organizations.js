...
const editOrganization = async (id, name, description, contactEmail, logoFilename) => {
    const query = `
      UPDATE organization
...
export { getAllOrganizations, getOrganizationById, createOrganization, editOrganization }